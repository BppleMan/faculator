...
use crate::game_data::{PrototypeNames, load_prototype_names};
use crate::icons::{FoundIcon, IconIndex, build_icon_index, scan_icon_sprites};
use crate::paths::detect_script_output;
...
mod tests {
    ...
    use crate::icons::{FoundIcon, IconIndex};
